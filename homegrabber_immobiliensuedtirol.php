...
echo "<br>************* GRABBER IMMOBILIEN SUEDTIROL ************* START"; 


$form_query_domain      ="http://www.immobilien-suedtirol.bz.it";
  
$full_articles_link_b   ="http://www.immobilien-suedtirol.bz.it/cgi-bin/manager/searchImm.pl?lang=it&zonaric=10&locationric=&rateric=&typeric=&metodo=v";
...
for($current_page=1;$current_page<2;$current_page++){
    ...
    $articles  = $xpath->query('//td[@class="link"]');
    $article_ind=1; $ind=0;
...
echo "<br>************* GRABBER IMMOBILIEN SUEDTIROL ************* STOP"; 
