...
class ADODB_odbc_mssql_n extends ADODB_odbc_mssql {
	var $databaseType = "odbc_mssql_n";
	
	function ADODB_odbc_mssql_n()
	{
	...
	function _query($sql,$inputarr=false)
	{
		...
		//echo $sql;
		return ADODB_odbc_mssql::_query($sql,$inputarr);
	}
...
class ADORecordSet_odbc_mssql_n extends ADORecordSet_odbc_mssql {
	var $databaseType = "odbc_mssql_n";
