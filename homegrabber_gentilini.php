...
IMMOBILIARE GENTILINI
*/
 
echo "<br>************* GRABBER GENTILINI ************* START"; 


$form_query_domain    ="http://www.immobiliaregentili.it/";
  
$full_articles_link_b   ="http://www.immobiliaregentili.it/web/immobili.asp?tipo_contratto=V&language=ita&pagref=62508&num_page=";
...
for($current_page=1;$current_page<7;$current_page++){
    ...
    {$ind++;
        ...
        $article["description"]        = @$article_xpath->query('//div[@class="imm-det-des"]')->item(0)->textContent; 
		 ...
		 //via
		$article["via"]         = @($article_xpath->query('//article/h2')->item(0)->textContent); 
        ...
        $newarticle["ag_images"]=array();
         ...
         //Images 
        $article_table= $article_xpath->query('//div[@class="row photogallery"]'); 
        ...
        $newarticle["ag_indirizzo"]=@$newarticle["ag_localita"].",".@$article["zona"];
...
echo "<br>************* GRABBER GENTILINI ************* STOP"; 
