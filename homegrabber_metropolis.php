...
echo "<br>************* GRABBER METROPOLIS ************* START"; 


$form_query_domain      ="http://www.metropolisbz.it/";
  
$full_articles_link_b   ="http://www.metropolisbz.it//web/immobili.asp?cod_categoria=R&cod_provincia=15&cod_ordine=O02&num_page=";
 

for($current_page=1;$current_page<4;$current_page++){
    ...
    $articles  = $xpath->query('//div[@class="element annuncio"]');
    $article_ind=1; $ind=0;
    ...
    {$ind++;
		...
		$article["price"]=@($article["price"]/1000);
		...
		//Provincia
        $article["provincia"]              = @$article_xpath->query('//div[@id="det_prov"]')->item(0)->getAttribute('data-valore');
...
echo "<br>************* GRABBER METROPOLIS ************* STOP"; 
